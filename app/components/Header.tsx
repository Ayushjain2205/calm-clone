...
export default function Header({ scrolled }: HeaderProps) {
  return (
    <header
      ...
      style={!scrolled ? { background: "linear-gradient(rgb(23, 98, 147) 0%, rgba(23, 98, 147, 0.337) 71%, rgba(23, 98, 147, 0) 100%)" } : {}}
    >
      <div className="flex items-center justify-between h-[100px]">
        <div className="flex items-center gap-8">
          <Link href="/" className="flex items-center">
            {!scrolled ? (
              ...
              <Image src="/calm-text.svg" alt="Calm Logo" width={103} height={41} priority />
            )}
          </Link>
        ...
        <div className="flex items-center gap-6">
          ...
          <Link
            href="/try-free"
            className={`text-white px-4 rounded-full inline-flex items-center justify-center font-medium ${scrolled ? "bg-[#4655AE]" : "bg-white bg-opacity-20 backdrop-blur-sm"}`}
            style={{
              width: "200px",
              height: "56px",
